...
//      if (user_category == "SU") {
      deletedCasesListJson = await getReceivedCaseResearch(Status,District,Type,from,to,start, limit);
      setState(() {
                  ...
                  children: [
                    FlatButton(
                      ...
                      onPressed: () {
                        ...
                        {
                          caseResearch( "DELETED", District, violenceType, fromDate, toDate, start,  limit);
                        }
                      },
                    ),
                  ],
